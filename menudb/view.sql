...
-- VIEW 를 통한 DML (VIEW 를 변경하면 원본도 변경됨)
...
-- VIEW 로 DML 명령어로 조작이 불가한 경우
-- 1. 뷰 정의에 포함되지 않은 컬럼을 조작하는 경우
-- 2. 뷰에 포함되지 않은 컬럼 중 베이스가 되는 컬럼이 NOT NULL 제약조건에 지정된 경우
-- 3. 산술 표현식이 정의된 경우
